@US
Feature: Trip watcher module verifying for the all verticals and result or details pages
  Owner: Komarov Igor
  ...
  @US @ACCEPTANCE
  Scenario: RTC-540 Hotel with Matching Type 1 Location and Date conditions
    Given customer without watched trips
    Given I authenticate myself
    When I am on hotel index page
    And  I'm searching for a hotel in "SFO"
