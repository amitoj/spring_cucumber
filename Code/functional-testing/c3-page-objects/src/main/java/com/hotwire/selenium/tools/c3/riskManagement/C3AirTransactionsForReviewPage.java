...
public class C3AirTransactionsForReviewPage extends ToolsAbstractPage {
    public C3AirTransactionsForReviewPage(WebDriver webDriver) {
        super(webDriver, By.xpath("//td[text()='The following are the Air transactions pending review.']"));
    }
