...
public class C3CarTransactionsForReviewPage extends ToolsAbstractPage {
    public C3CarTransactionsForReviewPage(WebDriver webDriver) {
        super(webDriver, By.xpath("//td[text()='The following are the Car transactions pending review.']"));
    }
