 ...
 */
public class MobileRulesAndRestrictionsPage extends MobileAbstractPage {

    @FindBy(xpath = "//img[contains(@alt, 'Back')]")
    private WebElement lnkBack;

    public MobileRulesAndRestrictionsPage(WebDriver webdriver) {
        super(webdriver, "tile.legal.restrictions");
    }
