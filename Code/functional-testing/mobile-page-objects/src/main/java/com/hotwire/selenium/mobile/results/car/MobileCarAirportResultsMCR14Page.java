...
public class MobileCarAirportResultsMCR14Page extends MobileAbstractPage implements MobileCarResultsPage {
    static final Logger LOGGER = LoggerFactory.getLogger(MobileCarAirportResultsMCR14Page.class.getSimpleName());
    @FindBy(css = ".searchNew>h1>span")
    private WebElement dateAndTime;
    @FindBy(css = ".carItem")
    private List<WebElement> searchResults;
    @SuppressWarnings("MismatchedQueryAndUpdateOfCollection")
    @FindBy(css = ".carItem.opaque")
    private List<WebElement> opaqueSearchResults;
    @SuppressWarnings("MismatchedQueryAndUpdateOfCollection")
    @FindBy(css = ".carItem.retail")
    private List<WebElement> retailSearchResults;

    public MobileCarAirportResultsMCR14Page(WebDriver webdriver) {
    ...
    public CarSolutionModel select(Integer resultNumberToSelect, String opaqueRetail) {
        ...
        carModel.setCarName(selectedCarResult.findElement(By.cssSelector(".carTypeName")).getText());
