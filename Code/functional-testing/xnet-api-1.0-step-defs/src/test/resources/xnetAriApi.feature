...
Feature: Xnet Ari API regression
  ...
  Scenario: Update Xnet Inventory using invalid username and password
    ...
    Then I should get authentication error
  ...
  Scenario Outline: Update Xnet Inventory for valid and invalid Currency
      ...
      Then I should get <response> error
       ...
       Examples: Currency validation
        ...
        |10153    | 4              | 5              | STANDARD   | 1                      | XHW        | usd      | 100    | 0           | No  |
        |10153    | 3              | 3              | STANDARD   | 1                      | XHW        | USDA      | 100    | 0           | Invalid currency length  |
        |10153    | 3              | 3              | STANDARD   | 1                      | XHW        | AUD      | 100    | 0           | Unknown currency  |
        |10153    | 3              | 3              | STANDARD   | 1                      | XHW        | US      | 100    | 0           | Invalid currency length  |
  ...
  Scenario Outline: Update Xnet Inventory for valid and invalid Date Range
    ...
    Then I should get <response> error
     ...
     Examples: Date Range validation
      | hotelId | startDateShift | endDateShift   | roomTypeId | totalInventoryAvailable | ratePlanId | currency | perDay | extraPerson | response |
      |10153    | 1              | 1              | STANDARD   | 1                      | XHW        | usd      | 50    | 0           | No  |
      |10153    | 400            | 450            | STANDARD   | 1                      | XHW        | usd      | 50    | 0           | No  |
      |10153    | 400            | 440            | STANDARD   | 1                      | XHW        | usd      | 50    | 0           | No  |
      |10153    | 2              | 62             | STANDARD   | 1                      | XHW        | usd      | 50    | 0           | End date not within range  |
      |10153    | 2              | 3              | STANDARD   | 1                      | XHW        | usd      | 50    | 0           | No  |
      |10153    | 5              | 3              | STANDARD   | 1                      | XHW        | usd      | 50    | 0           | Start date Not after end date |
      |10153    | 1              | 58             | STANDARD   | 1                      | XHW        | usd      | 50    | 0           | No  |
  ...
  Scenario Outline: Update Xnet Inventory for valid and invalid Hotel Id
    ...
    Examples: Hotel Id validation
      | hotelId | startDateShift | endDateShift   | roomTypeId | totalInventoryAvailable | ratePlanId | currency | perDay | extraPerson | response |
      |10153    | 1              | 2              | STANDARD   | 10                      | XHW        | USD      | 100    | 0           | No  |
  ...
  Scenario Outline: Update Xnet Inventory for valid and invalid Rate per day
    ...
    Then I should get <response> error
     ...
     Examples: Rate-Per day validation
      | hotelId | startDateShift | endDateShift   | roomTypeId | totalInventoryAvailable | ratePlanId | currency | perDay | extraPerson | response |
      |10153    | 4              | 5              | STANDARD   | 1                      | XHW        | usd      | 50    | 0           | No  |
      |10153    | 5              | 5              | STANDARD   | 1                      | XHW        | usd      | 50.99    | 0           | No  |
      |10153    | 6              | 6              | STANDARD   | 1                      | XHW        | usd      | 0    | 0           | No  |
      |10153    | 7              | 7              | STANDARD   | 1                      | XHW        | usd      | 0.00    | 0           | No  |
      |10153    | 8              | 8              | STANDARD   | 1                      | XHW        | usd      | 9999.111    | 0           | No  |
      |10153    | 8              | 8              | STANDARD   | 1                      | XHW        | usd      | 1000000    | 0           | Rate not in range  |
  ...
  Scenario Outline: Update Xnet Inventory for different Restrictions
    ...
    Examples: Hotel Id validation
      ...
      |10153    | 1              | 2              | STANDARD   | 10                      | XHW        | USD      | 100    | 0           | No       | Active   | Inactive |
      |10153    | 1              | 2              | STANDARD   | 10                      | XHW        | USD      | 100    | 0           | No       | Inactive | Inactive |
      |10153    | 1              | 2              | STANDARD   | 10                      | XHW        | USD      | 100    | 0           | No       | Active   | Active   |
      |10153    | 1              | 2              | STANDARD   | 10                      | XHW        | USD      | 100    | 0           | No       | Inactive | Active   |
  ...
  Scenario Outline: Update Xnet Inventory for valid and invalid room type
    ...
    Examples: Room type validation
      | hotelId | startDateShift | endDateShift   | roomTypeId | totalInventoryAvailable | ratePlanId | currency | perDay | extraPerson | response |
      |10153    | 4              | 5              | STANDARD   | 12                      | XHW        | USD      | 20    | 10           | No  |
      |10153    | 1              | 2              | standard   | 10                      | XHW        | USD      | 100    | 0           | Unknown room type |
  ...
  Scenario Outline: Update Xnet Inventory for valid and invalid Total Inventory
    ...
    Examples: Total Inventory validation
      | hotelId | startDateShift | endDateShift   | roomTypeId | totalInventoryAvailable | ratePlanId | currency | perDay | extraPerson | response |
      |10153    | 1              | 2              | STANDARD   | 5000                      | XHW        | USD      | 100    | 0           | Inventory not in range  |
      |10153    | 1              | 2              | STANDARD   | -20                      | XHW        | USD      | 100    | 0           | Inventory not in range  |
      |10153    | 3              | 3              | STANDARD   | 4999                      | XHW        | USD      | 100    | 0           | No  |
