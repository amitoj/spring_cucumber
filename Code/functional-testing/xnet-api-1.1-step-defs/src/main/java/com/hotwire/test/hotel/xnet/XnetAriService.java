...
/**
 * We treat Xnet ARI as a service for a supplier. He can use this service to upload his rates. The actual implementation
 * (xnet web app or xnet api or something else in the future) is hidden behind this interface. This interface should
 * have only the stuff a supplier can do with this service but with no reference to actual implementation. This helps to
 * write more implementation agnostic step defs and feature files.
 *
...
public interface XnetAriService {
     ...
     */
    void addAvailRateUpdate(Date from, Date to, Boolean isSun, Boolean isMon, Boolean isTue, Boolean isWed,
     ...
     *
     * @param extraPersonRate
     *            - the rate for extra person
     */
     ...
     *
     * @param totalInventoryAvailable
     *            - the total number of available inventory
     */
     ...
     *             if any error occurs
     */
    void updateInventory() throws XnetServiceException;

    void setInvalidSupplier();

    void setValidSupplier(String userType);
    ...
    /**
     * allows to set headers for admin/super user
     */
    void setXnetServiceHeaders();
