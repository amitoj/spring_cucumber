 ...
 */
public class XnetServiceException extends RuntimeException {
    ...
    public static final String ERROR_CODE_BR_EMPTY_RESPONSE = "BR101";
    public static final String ERROR_CODE_INVALID_HOTEL_ID  =  "ARI200";
    public static final String ERROR_CODE_UNSUPPORTED_OPERATION = "BR1000";
    public static final String ERROR_CODE_BR_INVALID_MINS_IN_PAST = "BR900";

    private static final long serialVersionUID = XnetServiceException.class.getSimpleName().hashCode();
     ...
     */
    public XnetServiceException(String errorCode, String message) {
        super(message);
     ...
     */
    public XnetServiceException(String errorCode, String message, Throwable cause) {
        super(message, cause);
        this.errorCode = errorCode;
    }
